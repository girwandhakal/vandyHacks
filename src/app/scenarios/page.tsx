...
import { mockScenario, mockProcedures } from "@/lib/mock/scenarios";
import {
  Search,
  Wallet,
  CreditCard,
...
export default function ScenariosPage() {
  const [selectedProcedure, setSelectedProcedure] = useState(mockScenario.name);
  const [selectedPlan, setSelectedPlan] = useState<string | null>(null);
  const scenario = mockScenario;

  const strainColors = {
    low: { bg: "bg-success-muted", text: "text-success", label: "Low Strain" },
    moderate: { bg: "bg-warning-muted", text: "text-warning", label: "Moderate Strain" },
    high: { bg: "bg-danger-muted", text: "text-danger", label: "High Strain" },
  };
  const strain = strainColors[scenario.financialStrainLevel];
    ...
    <div className="page-container">
      ...
      <AnimateIn delay={0.1}>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="card-base text-center">
            ...
            <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${strain.bg} ${strain.text} text-sm font-medium mt-1`}>
          ...
          <div className="card-base">
            ...
            <div className="text-center py-4">
              ...
              <p className="text-xs text-neutral-400 mt-2">
                Based on {formatCurrency(scenario.monthlyPayment)}/mo payment plan
              </p>
            </div>
          </div>
        </div>
      ...
      <AnimateIn delay={0.2}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {scenario.paymentScenarios.map((plan, idx) => {
